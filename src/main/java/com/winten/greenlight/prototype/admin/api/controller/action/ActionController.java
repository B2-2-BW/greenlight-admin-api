...
public class ActionController {
    ...
    public ResponseEntity<List<Action>> getActionsByGroup(@PathVariable Long actionGroupId,
    ...
    // GET /actions
    @GetMapping("/actions")
    public ResponseEntity<List<Action>> getAllActions(@AuthenticationPrincipal final CurrentUser currentUser) {
    ...
    public ResponseEntity<Action> updateActionById(
        ...
        Action action = request.toAction();
        action.setId(actionId);

        Action result = actionService.updateActionById(action, request.toActionRules(), currentUser);
        return ResponseEntity.ok(result);
    }

    @DeleteMapping("/actions/{actionId}")
    public ResponseEntity<Action> deleteActionById(@PathVariable Long actionId,
                                                           @AuthenticationPrincipal final CurrentUser currentUser) {
